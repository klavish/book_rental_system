            ...
            <tbody>
                ...
                $db->sql("select * from users left join image_file on users.userId = image_file.userId");
                 ...
                 <tr class="border">
                    ...
                    <td class="border"><?php echo $row['created'];?></td>
                    <td class="border"><?php echo $row['modified'];?></td>
                    <td class="border">
                        <a class="border bg-blue-800 text-white text-sm  px-4 py-2 rounded-md" href="delete_user.php?userId=<?php echo $row['userId'];?>">delete</a>
                    </td>
                 </tr>
                 <?php   endforeach ?>
