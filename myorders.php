    ...
    <main class="flex items-center justify-center  space-x-8 container p-6 ">
        ...
        <div class="flex  flex-wrap flex-col items-center justify-center">
            <div class="flex flex-col flex-1  items-start">
                ...
                <?php $userId = $_SESSION['loginUser'];
                $db = new Database();
                $db->sql("SELECT * FROM rentedbooks
                LEFT JOIN categories ON rentedbooks.categoryId = categories.categoryId
                LEFT JOIN books ON rentedbooks.bookId = books.bookId
                LEFT JOIN returnedbooks ON rentedbooks.bookId = returnedbooks.bookId
                WHERE rentedbooks.userId = '$userId'");
            ...
            <div class="flex  flex-1 p-4  space-y-5">
